...
Ext.define('BAML.view.grid.plugin.GridFilterRow', {
  extend:'Ext.util.Observable',
  alias: 'plugin.view.GridFilterRow',
  ptype: 'gridfilterrow',
  ...
  init               : function ( grid ) {
    ...
    var Filter = BAML.view.grid.plugin.GridFilterRowFilter;
...
Ext.PluginManager.registerType( "gridfilterrow", BAML.view.grid.plugin.GridFilterRow );
...
Ext.define('BAML.view.grid.plugin.GridFilterRowFilter', {
  extend:'Ext.util.Observable',
  alias: 'plugin.view.GridFilterRowFilter',
