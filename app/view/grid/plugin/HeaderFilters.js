...
Ext.define('BAML.view.grid.plugin.HeaderFilters', {
  extend: 'Ext.grid.feature.Feature',
  alias: 'feature.gridheaderfilters',
  ptype: 'feature.gridheaderfilters',

  alternateClassName: ['BAML.view.grid.HeaderFilters', 'BAML.view.grid.header.Filters'],
  ...
  renderFilters: function() {
    ...
    var columns = this.grid.view.getGridColumns();
